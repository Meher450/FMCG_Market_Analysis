...
- Centralize sales, volume, and profitability metrics  
...
2. Open `FMCG_Analytics_Dashboard.pbix`
3. Ensure all files in the `Datasets/` folder are correctly linked
4. Interact with filters, slicers, and report pages to explore insights
...
- Profitability metrics by channel or market  
- Regional hierarchy and geographic mappings  

> ⚠️ Ensure column names and data types align with the Power BI data model, or update the model accordingly.
...
The `Project_Requirements.pdf` document outlines:

- Business goals and analytical use cases  
- Expected dataset schemas  
- KPI definitions and calculation logic  
- Stakeholder reporting expectations  

Review this document before extending or modifying the dashboard.
...
- Trend monitoring and variance analysis  
- Data-driven FMCG decision-making  
